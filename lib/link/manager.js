...
//
import { getCurrentLine, selectRange, getCursorPosition } from '../utility/editor/editor';
...
// Jump
import { getPreviousHistory } from './jump-history';
// TOC
import Toc from './toc';
...
class LinkManager {
  ...
  jumpBackward() {
    ...
    const history = getPreviousHistory();
  ...
  pasteLastRegisteredLink() {
    ...
    if (link) {
      ...
      if (linkText) {
        ...
        select(LinkHelper.getTitleRange(currentLine));
